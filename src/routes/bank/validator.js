...
module.exports = new (class {
    ...
    bnkBanksInsertValidator() {
        return [
            ...
            check("iranId").not().isEmpty().withMessage("iranId cant be empty"),
            check("branchCode")
                .not()
                .isEmpty()
            ...
            check("eCard").not().isEmpty().withMessage("eCard cant be empty"),
            check("owner").not().isEmpty().withMessage("owner cant be empty"),
            check("addressBank")
                .not()
                .isEmpty()
    ...
    setBankGateValidator() {
        return [
            check("agencyId")
                .not()
                .isEmpty()
                .withMessage("agencyId cant be empty"),
            check("bankName").isString().withMessage("bankName cant be empty"),
            check("bankCode").isString().withMessage("bankCode cant be empty"),
            check("type").not().isEmpty().withMessage("type is boolean"),
            check("card").isString().withMessage("card is int"),
            check("terminal").isString().withMessage("terminal is int"),
            check("userName").isString().withMessage("userName is int"),
            check("userPass").isString().withMessage("userPass is int"),
            check("hesab").not().isEmpty().withMessage("hesab is int"),
            check("active").isBoolean().withMessage("active is int"),
            check("personal").isBoolean().withMessage("personal is int"),
        ];
    }
})();

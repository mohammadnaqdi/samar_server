...
router.get(
    "/ChangeDistance",
    isEnyAdmin,
    controller.changeDistance.bind(controller)
);
...
router.get(
    "/ApplyStudentPrePayment",
    controller.applyStudentPrePayment.bind(controller)
);
router.post(
    "/ServiceListDoc",
...
router.get(
    "/findStudentsByNameOrPhone",
    controller.findStudentsByNameOrPhone.bind(controller)
);

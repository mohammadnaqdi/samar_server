...
router.post(
  "/GetAddress2",
  validator.getAddress2Validator(),
  controller.validate.bind(controller),
  controller.getAddress2.bind(controller)
);
...
router.get(
  "/GetCityProvinceByDistrict",
  controller.getCityProvinceByDistrict.bind(controller)
);
...
router.post(
  "/SetCity",
  validator.setCityValidator(),
  controller.validate.bind(controller),
  controller.setCity.bind(controller)
);
